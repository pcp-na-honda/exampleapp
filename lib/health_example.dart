...
class _HealthAppState extends State<MyHealthPage> {
    ...
    if (requested) {
      try {
        ...
        List<HealthDataPoint> healthData =
            await health.getHealthDataFromTypes(todayFrom/*yesterday*/, now, types);
  ...
  Future deleteData() async {
    ...
    success &= await health.delete(HealthDataType.SLEEP_ASLEEP, earlier, now);//miura++
    success &= await health.delete(HealthDataType.SLEEP_AWAKE, earlier, now);//miura++
    success &= await health.delete(HealthDataType.SLEEP_IN_BED, earlier, now);//miura++
